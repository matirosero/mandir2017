...
<aside class="spotlight expanded collapse row">
	<div class="spotlight-image medium-6 columns hide-for-small-only">
		<a href="<?php echo $directory_url; ?>" id="" class="" data-equalizer-watch>
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/img/spotlight-home.jpg" alt="Profesor en clase de yoga" />
		</a>
	</div>
	<div class="medium-6 columns">
		<div class="spotlight-text">
			...
			<a href="<?php echo $directory_url; ?>">Ir a Red Mandir Certificados</a>
		</div>
	</div>
</aside>